 ...
 * @author Hp
 */
public class Lavado extends javax.swing.JDialog {

    /**
     * Creates new form Carril
     */
    public Lavado(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                Lavado dialog = new Lavado(new javax.swing.JFrame(), true);
